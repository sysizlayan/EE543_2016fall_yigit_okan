...
encoder = tflearn.input_data(shape=[None, 10000])
encoder = tflearn.fully_connected(encoder, 256)
encoder = tflearn.fully_connected(encoder, 64)

# Building the decoder
decoder = tflearn.fully_connected(encoder, 256)
decoder = tflearn.fully_connected(decoder, 10000)
...
for i in range(10):
    a[0][i].imshow(np.reshape(testX[i], (100, 100)), cmap='gray')
